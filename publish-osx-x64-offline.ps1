...
dotnet clean ./martridge/src/martridge.csproj --configuration Release -p:Platform="osx-x64" --framework net10.0
dotnet publish ./martridge/src/martridge.csproj --output ./publish/net10.0_osx-x64_offline/martridge/ --configuration Release -p:Platform="osx-x64" --framework net10.0 --runtime osx-x64 --self-contained true -p:PublishSingleFile=true -p:DisableFeatureOnline=true