...
dotnet publish ./martridge/src/martridge.csproj --output ./publish/net10.0_win-x64/martridge/ --configuration Release -p:Platform="win-x64" --framework net10.0 --runtime win-x64 --self-contained true -p:PublishSingleFile=true -p:IncludeNativeLibrariesForSelfExtract=true