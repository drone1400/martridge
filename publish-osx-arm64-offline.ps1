...
dotnet clean ./martridge/src/martridge.csproj --configuration Release -p:Platform="osx-arm64" --framework net10.0
dotnet publish ./martridge/src/martridge.csproj --output ./publish/net10.0_osx-arm64_offline/martridge/ --configuration Release -p:Platform="osx-arm64" --framework net10.0 --runtime osx-arm64 --self-contained true -p:PublishSingleFile=true -p:DisableFeatureOnline=true