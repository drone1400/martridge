...
dotnet publish ./martridge/src/martridge.csproj --output ./publish/net10.0_linux-x64/martridge/ --configuration Release -p:Platform="Any CPU" --framework net10.0 --runtime linux-x64 --self-contained true -p:PublishSingleFile=true