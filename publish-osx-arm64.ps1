...
dotnet publish ./martridge/src/martridge.csproj --output ./publish/net10.0_osx-arm64/martridge/ --configuration Release -p:Platform="Any CPU" --framework net10.0 --runtime osx-arm64 --self-contained true -p:PublishSingleFile=true