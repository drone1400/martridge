...
namespace Martridge.ViewModels.Configuration {
    public class SettingsEnvVarAppendEndViewModel : SettingsEnvVarViewModelBase {
        /// <summary>
        ...
        public SettingsEnvVarAppendEndViewModel() {}
        public SettingsEnvVarAppendEndViewModel(string key, string value, bool isEnabled, string appendSeparator) {
            this._key = key;
            this._value = value;
        ...
        public override ConfigDataEnvironmentVariable GetConfigData() {
            return new ConfigDataEnvironmentVariable() {
                ...
                Mode = nameof(ConfigEnvVarMode.AppendEnd),
        ...
        public override ConfigEnvironmentVariable GetConfig() {
            return new ConfigEnvironmentVariable(
                ...
                value: this.Value,
                isEnabled: this.IsEnabled,
                mode: ConfigEnvVarMode.AppendEnd,
                appendSeparator: this._appendAppendSeparator);
        }
    }
}
