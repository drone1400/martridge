...
dotnet publish ./martridge/src/martridge.csproj --output ./publish/net10.0_win-x86_offline/martridge/ --configuration Release -p:Platform="win-x86" --framework net10.0 --runtime win-x64 --self-contained true -p:PublishSingleFile=true -p:IncludeNativeLibrariesForSelfExtract=true -p:DisableFeatureOnline=true