...
dotnet publish ./martridge/src/martridge.csproj --output ./publish/net10.0_linux-arm64_offline/martridge/ --configuration Release -p:Platform="linux-arm64" --framework net10.0 --runtime linux-arm64 --self-contained true -p:PublishSingleFile=true -p:DisableFeatureOnline=true