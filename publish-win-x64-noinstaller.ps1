...
dotnet publish ./martridge/src/martridge.csproj --output ./publish/net8.0_win-x64-noinstaller/martridge/ --configuration Release -p:Platform="x64" --framework net8.0 --runtime win-x64 --self-contained true -p:PublishSingleFile=true -p:IncludeNativeLibrariesForSelfExtract=true -p:DisableFeatureDinkInstaller=true