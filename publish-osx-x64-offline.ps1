...
dotnet publish ./martridge/src/martridge.csproj --output ./publish/net10.0_osx-x64-offline/martridge/ --configuration Release -p:Platform="Any CPU" --framework net10.0 --runtime osx-x64 --self-contained true -p:PublishSingleFile=true -p:DisableFeatureOnline=true