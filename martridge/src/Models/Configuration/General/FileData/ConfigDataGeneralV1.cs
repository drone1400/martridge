...
namespace Martridge.Models.Configuration.General.FileData {
    ...
    /// </summary>
    public class ConfigDataGeneralV1 {
        /// <summary>
        ...
        public Dictionary<string, object?> GetValues() {
            ...
            if (string.IsNullOrWhiteSpace(this.DefaultDmodLocation) == false) {
                dmodPaths.Add(this.DefaultDmodLocation);
            }
            if (this.AdditionalDmodLocations != null && this.AdditionalDmodLocations.Count > 0) {
                dmodPaths.AddRange(this.AdditionalDmodLocations);
            }
            ...
            return new Dictionary<string, object?>() {
                ...
                [nameof(ConfigGeneral.DmodPaths)] = dmodPaths,
